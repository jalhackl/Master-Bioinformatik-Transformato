...
from the PDBbind data set were used. Thus, the selection is rather diverse and many  'trivial' structures are over-represented. It could be insightful to use
