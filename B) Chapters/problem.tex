...
\caption{Example for the differences between \textt{iter-} and \textt{iter\_change}-algorithm;
above: \textt{iter}; below: \textt{iter-change}; \textt{iter-change }processes all atoms within
