...
% SB, added a comment just to test github sync ..
\begin{document}
	...
	\mainmatter{}
	\input{B) Chapters/introduction}
	\input{B) Chapters/free_energy_calculations}
	\input{B) Chapters/transformato}
	\input{B) Chapters/problem}
	\input{B) Chapters/results}
	\input{B) Chapters/conclusion}
	
	\input{B) Chapters/appendix}
